    ...
    <footer className="relative w-full max-w-screen-xl mx-auto border-t pt-10">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <div>
            ...
            <div className="flex lg:pr-4">
              ...
              />
              <Button className="rounded-l-none dark:bg-gray-700 dark:text-white">Subscribe</Button>
            </div>
          </div>
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 dark:text-white dark:opacity-100"
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Staff Sync</a>. All
            Rights Reserved.
          </Typography>
