  ...
  return (
    <>
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="group peer ring-0 bg-gray-200 text-gray-900 rounded-full border border-gray-900 duration-500 after:duration-300 w-16 h-8  shadow-md peer-checked:bg-gray-900 peer-checked:text-gray-200 after:content-[''] after:rounded-full after:absolute after:bg-gray-900 after:h-6 after:w-6 after:top-1 after:left-1 peer-checked:after:bg-white peer-checked:after:translate-x-8 flex justify-between items-center px-2">
