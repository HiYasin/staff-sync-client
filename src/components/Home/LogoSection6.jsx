      ...
      <div className="container !mx-auto text-center place-content-center grid">
        ...
        <div className="flex flex-col md:flex-row gap-6 max-w-6xl mx-auto">
          <div className="flex flex-col items-center justify-center gap-6">
            <Card shadow={false} className="bg-[#FAFAFA] px-10 hover:bg-gray-300 cursor-pointer transition-all duration-400">
              <CardBody>
                <img
          ...
          <Card shadow={false} className="bg-[#FAFAFA] lg:px-10 justify-center max-w-[18rem] lg:max-w-lg hover:bg-gray-300 cursor-pointer transition-all duration-400">
